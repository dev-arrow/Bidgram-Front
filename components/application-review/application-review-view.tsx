...
export function ApplicationReviewView() {
  ...
  return (
    <main className="flex min-h-0 flex-1 flex-col overflow-y-auto xl:overflow-hidden">
      ...
      <div className="flex min-h-0 flex-1 flex-col xl:flex-row xl:overflow-hidden">
        <aside className="flex w-full shrink-0 flex-col border-b border-border bg-card/50 xl:w-[390px] xl:overflow-y-auto xl:border-r xl:border-b-0">
