...
import {
  Archive, BriefcaseBusiness, Building2, CalendarDays, Check, ChevronRight,
...
export function ApplicationReviewView() {
  ...
  return (
    <main className="flex min-h-0 flex-1 flex-col overflow-y-auto">
      ...
      <div className="flex flex-1 flex-col xl:flex-row xl:items-start">
